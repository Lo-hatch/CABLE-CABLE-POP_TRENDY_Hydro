...
# Global Meteorology
MetPath='/g/data/x45/CRUJRA2023/daily_1deg'
# MetVersion
MetVersion='CRUJRA_2023'
# Global LUC
TransitionFilePath='/g/data/x45/LUH2/GCB_2023/1deg/EXTRACT'
# Global Surface file 
SurfaceFile='/g/data/pr09/TRENDY_v12/aux/gridinfo_CSIRO_1x1.nc'
# Output directory of the run
runpath='/g/data/pr09/TRENDY_v12/S0/run100'
# Land Mask used for this run
LandMaskFile='/g/data/pr09/TRENDY_v12/S0/run100/landmask/landmask100.nc'
