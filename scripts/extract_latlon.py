...
optional arguments:
  ...
  -o output_netcdf, --outfile output_netcdf
                        ...
                        (default: input-extract_latlon.nc).
...
parser.add_argument('ifiles', nargs='*', default=None,
                    metavar='lat,lon input_netcdf',
...
for d in fi.dimensions.values():
    ...
    if ( d.name == 'lat' or d.name == 'latitude' or d.name == 'lon' or
         d.name == 'longitude' ):
        l = nlatlon
